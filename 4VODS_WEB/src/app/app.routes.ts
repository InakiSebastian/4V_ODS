...
import { AddIniciativeViewComponent } from './components/pages/add-iniciative-view/add-iniciative-view.component';
...
export const routes: Routes = [
    ...
    { path: 'addIniciatives/:acction', component: AddIniciativeViewComponent },
